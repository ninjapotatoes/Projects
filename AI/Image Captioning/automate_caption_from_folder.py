#make sure you activate env source my_env/bin/activate
#this takes a path and captions each image in the folder locally
#havent actually tested if this works but should in theory this might take 10 gb of space though for the blip2 model so make sure to use a diff one
