...
public void setUp() {
  ...
  /**
   * Tests sorting integers using quick sort.
   */
  @Test
public void testSortIntegers() {
  ...
  /**
 * Tests sorting students using quick sort.
 */
  @Test
public void testSortStudent() {
    ...
    //First element
    QuickSorter<Integer> firstElementSorter = new QuickSorter<>(QuickSorter.FIRST_ELEMENT_SELECTOR);
    firstElementSorter.sort(dataAscending);
    assertEquals(Integer.valueOf(1), dataAscending[0]);
    
    //Last element
    QuickSorter<Integer> lastElementSorter = new QuickSorter<>(QuickSorter.LAST_ELEMENT_SELECTOR);
    lastElementSorter.sort(dataDescending);
    assertEquals(Integer.valueOf(1), dataDescending[0]);
    
    //Middle element
    QuickSorter<Integer> middleElementSorter = new QuickSorter<>(
        QuickSorter.MIDDLE_ELEMENT_SELECTOR);
    middleElementSorter.sort(dataAscending);
    assertEquals(Integer.valueOf(1), dataAscending[0]);
    
    //Random element
    QuickSorter<Integer> randomElementSorter = 
        new QuickSorter<>(QuickSorter.RANDOM_ELEMENT_SELECTOR);
    randomElementSorter.sort(dataRandom);
    assertEquals(Integer.valueOf(1), dataRandom[0]);
  }
}
