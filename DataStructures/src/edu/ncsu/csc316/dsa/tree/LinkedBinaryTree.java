...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
    ...
    /*
     * In this method my program is based on the method numChildren given in the textbook for this class
     * on page 329 "Data Structures and Algorithms" by Goodrich, Tamassia, and Goldwasser
     */
    @Override
    public E remove(Position<E> p) {
        ...
        if (numChildren(p) == 2) {
            throw new UnsupportedOperationException("Removal of a node with two children is not supported.");
        }
        
        //if child is not null set its parent to this nodes parent
        if(child != null) {
        ...
        if (node == root) {
        	...
        	//if not the root then set the child to the parents left or right
