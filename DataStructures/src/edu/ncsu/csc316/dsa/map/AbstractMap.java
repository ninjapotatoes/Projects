...
public abstract class AbstractMap<K, V> implements Map<K, V> {
    ...
    protected static class MapEntry<K, V> implements Entry<K, V> {
        ...
        /**
         * Compares the current map entry with the parameter map entry.
         *
         * @param o map entry to be compared
         * @return 0 entries are equal, negative if current entry is less than param, or positive
         * if entry is more than parameter.
         */
