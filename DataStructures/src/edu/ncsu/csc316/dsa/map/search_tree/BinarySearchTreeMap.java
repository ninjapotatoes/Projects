...
public class BinarySearchTreeMap<K extends Comparable<K>, V> extends AbstractOrderedMap<K, V> {
     ...
     * @param compare the item being compared
     */
    ...
    /**
     * Returns the size of the binary search tree map
     * @return size of map
     */
    @Override
    public int size() {
    ...
    protected static class BalanceableBinaryTree<K, V> extends LinkedBinaryTree<Entry<K, V>> {
        ...
        public void rotate(Position<Entry<K, V>> p) {
            ...
            BinaryTreeNode<Entry<K, V>> parent = (BinaryTreeNode<Entry<K, V>>) node.getParent();
            BinaryTreeNode<Entry<K, V>> grandparent = (parent != null) ? (BinaryTreeNode<Entry<K, V>>) parent.getParent() : null;
            ...
            if (node == parent.getLeft()) {
                relink(parent, (BinaryTreeNode<Entry<K, V>>) node.getRight(), true);
                relink(node, parent, false);
            } else {
                relink(parent, (BinaryTreeNode<Entry<K, V>>) node.getLeft(), false);
